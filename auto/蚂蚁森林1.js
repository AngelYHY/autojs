...
let $$init = {
    check() {
        ...
        function checkModulesMap() {
            void [
                ...
                !files.exists(".Ant_Forest/Modules/" + mod + ".js")
            )).some((mod, idx, arr) => {
                let _str = "";
    ...
    global() {
        ...
        function setGlobalFunctions() {
            require(".Ant_Forest/Modules/MODULE_MONSTER_FUNC").load([
        ...
        function setGlobalExtensions() {
            ...
            global.$$unlk = require(".Ant_Forest/Modules/MODULE_UNLOCK");
            global.$$flag = {autojs_has_root: global._$_autojs_has_root};
            global.$$sto = {
                af: require(".Ant_Forest/Modules/MODULE_STORAGE").create("af"),
                af_cfg: require(".Ant_Forest/Modules/MODULE_STORAGE").create("af_cfg"),
                af_blist: require(".Ant_Forest/Modules/MODULE_STORAGE").create("af_blist"),
                af_flist: require(".Ant_Forest/Modules/MODULE_STORAGE").create("af_flist"),
                                    ...
                                    function _login() {
                                        ...
                                        function _inputCode(code_raw) {
                                            ...
                                            function _autoIpt() {
                                                ...
                                                let _dec = require(".Ant_Forest/Modules/MODULE_PWMAP").decrypt;
